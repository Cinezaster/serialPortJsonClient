								...
								<div className="col s12">
									<div className="card-panel indigo lighten-5">
	          							...
	          							<div>
	          								<button 
	          									style={{width:'100%'}}
	          									className="disabled btn waves-effect waves-light indigo lighten-3"
	          									>Exit SPJS</button>
	          							</div>
        							</div>
								</div>
					...
					<div className='col s6'>
						...
						{!this.state.spjc.serialPortConnection?
							<div>
								...
								<div className="row">
									<button 
										className={`btn waves-effect waves-light col s12 ${this.parametersAreSet(this.state.serialConnection)? '':'disabled'}`}
										onClick={this.connectSerialPort}>Connect Serial Port</button>
								</div>
							</div>
						:
